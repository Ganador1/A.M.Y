...
**Draft for external mathematical review — not a published paper.** 20 September 2026.
...
The observed research process used AMY-selected requests with supplied deterministic optimization and verification code. This compact note does not establish the complete historical search chronology, and it does not attribute independent invention of the algorithm to AMY. The full search-lineage archive, a broader priority review and external mathematical review remain publication gates.
