...
Informe y paquetes: campaña completa (historical run report, not included), paquete de 36 misiones (historical run report, not included), contratos locales (historical run report, not included). Los contratos de QA local fueron elegidos por Codex y no se cuentan como investigaciones autónomas del agente.
