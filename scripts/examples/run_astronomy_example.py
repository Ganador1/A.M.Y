...
Requires the Atlas worker with Astropy. Examples use stored constants and specified theoretical models; they do not fetch observations.
...
DOMAIN = 'astronomy'
CASES = [('astropy_constants', 'G', 'Read the gravitational constant with its reference and stated uncertainty.'), ('astropy_cosmology', 'luminosity_distance:1.0', 'Luminosity distance at redshift 1 in the built-in Planck18 cosmology.'), ('astropy_blackbody', '5778', 'Ideal blackbody at 5778 K; this approximates stellar emission, not an observed solar spectrum.')]
