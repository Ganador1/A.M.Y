...
## [1.1.0rc1] — 2026-09-20 — Release candidate

### Added
- Persistent runtime receipts, per-run execution evidence, inherited artifact checks and reversible memory checkpoints.
- Bounded native calibration campaigns, quantitative session closure and independently checkable scientific certificates.
- English release documentation, publication claim classification, and a portable exact autocorrelation witness.

### Fixed
- Decision parsing that selected embedded examples instead of final actions; explicit incomplete and ambiguous output rejection.
