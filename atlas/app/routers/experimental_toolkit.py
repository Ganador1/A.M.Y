...
from app.services.experimental_toolkit_hub import (
    get_experimental_hub,
    ExperimentalResult,
    ExperimentalToolkitHub,
)
from app.types.experimental_toolkit_types import (
    RunExperimentResult,
    RunBatchExperimentsResult,
    ValidateResultsResult,
    CheckReproducibilityResult,
    QuickMolecularPropertiesResult,
    QuickProteinFoldResult,
    GetExamplesResult,
)
from app.services.experimental_validator import (
...
async def run_experiment(request: ExperimentRequest) -> RunExperimentResult:
    """
...
async def run_batch_experiments(request: BatchExperimentRequest) -> RunBatchExperimentsResult:
    """
...
async def validate_results(request: ValidationRequest) -> ValidateResultsResult:
    """
...
async def check_reproducibility(request: ReproducibilityRequest) -> CheckReproducibilityResult:
    """
...
async def quick_molecular_properties(smiles: str) -> QuickMolecularPropertiesResult:
    """
...
async def quick_protein_fold(sequence: str) -> QuickProteinFoldResult:
    """
...
@router.get("/examples")
async def get_examples() -> GetExamplesResult:
    """
