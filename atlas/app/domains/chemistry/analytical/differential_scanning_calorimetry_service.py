...
class DifferentialScanningCalorimetryService(BaseService):
    ...
    async def perform_kinetics_analysis(
        ...
        try:
            ...
            # Calculate confidence level based on correlation (scalar coefficient)
    ...
    def _kissinger_analysis(
        ...
        # Calculate correlation coefficient (scalar r between x and y)
        correlation_coeff = float(np.corrcoef(x, y)[0, 1])

        return activation_energy, pre_exp_factor, correlation_coeff
