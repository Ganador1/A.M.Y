...
try:
    ...
    # cobra may be installed but fail on import (e.g., missing libsbml features); treat as unavailable for tests
    COBRAPY_AVAILABLE = False
    logger.warning("COBRApy not available or failed to import - treating as unavailable for tests")
