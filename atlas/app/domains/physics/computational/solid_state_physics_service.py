...
try:
    ...
    logger.warning("Astropy not available - pip install astropy")
...
class SolidStatePhysicsService(BaseService):
    ...
    async def quantum_espresso_calculation(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            except QuantumError as calc_error:
                return {
                    "success": False,
    ...
    async def astrophysical_material_analysis(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            from astropy import units as u
            from astropy.constants import k_B, h, c, G, M_sun
            import astropy
            ...
            if environment == "stellar_interior":
                ...
                degeneracy_param = (h**2 / (2 * np.pi * u.m_e * k_B * temperature)) * number_density**(2/3)
                ...
                chandrasekhar_mass = (G**-1.5 * (h*c/u.m_p)**1.5 * u.m_p**-2).to(u.M_sun)
                ...
                result = {
                    ...
                    "analysis": {
                        ...
                        "electron_fermi_energy": (h**2/(2*u.m_e) * (3*np.pi**2 * density/(u.m_p))**(2/3)).to(u.eV).value,
                        "degenerate": True
                    }
                }
    ...
    async def cosmological_simulation(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if simulation_type == "structure_formation":
