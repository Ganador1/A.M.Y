...
from ..personalized.personalized_medicine_service import PersonalizedMedicineService
...
@router.get("/health")
async def personalized_medicine_health() -> Dict[str, Any]:
    """
...
async def get_drug_recommendations(drug_name: str) -> Dict[str, Any]:
    """
...
async def get_pgx_genes() -> Dict[str, Any]:
    """
...
async def check_drug_interactions(phenotypes: Dict[str, str]) -> Dict[str, Any]:
    """
