...
- Expected experimental outcomes"""
    ...
    tool_success_rate = aggregate.get("avg_signal", aggregate.get("mean_signal", 0))  # Usar avg_signal o mean_signal
...
Use rigorous scientific language and domain-specific terminology."""
    ...
    paper_text = publication_response if isinstance(publication_response, str) else str(publication_response)
    ...
    overall_score = (
        ...
        tool_success_rate * 0.25 +     # Éxito de herramientas (25%) - ¡AHORA CORREGIDO!
