#!/usr/bin/env python3
"""
Test script directo para verificar las mejoras del PlausibilityScoringService
"""
...
spec = importlib.util.spec_from_file_location(
    "plausibility_scoring_service", 
    Path(__file__).parent / "app" / "services" / "plausibility_scoring_service.py"
)
plausibility_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(plausibility_module)

PlausibilityScoringService = plausibility_module.PausibilityScoringService
